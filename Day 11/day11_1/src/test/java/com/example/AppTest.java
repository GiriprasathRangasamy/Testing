...
public class AppTest {
    ...
    public void before() throws Exception{
        ExtentSparkReporter exsprk = new ExtentSparkReporter("D:\\SEllinium\\Class work\\Day 11\\report1.html");
    ...
    public void test1() throws Exception
    {
        ...
        PropertyConfigurator.configure("D:\\SEllinium\\Class work\\Day 11\\day11_1\\src\\main\\java\\com\\log4j2.properties");
        FileInputStream fs = new FileInputStream("D:\\SEllinium\\Class work\\Day 11\\sec1excel.xlsx");
    ...
    public void afterTest(ITestResult result) throws Exception{
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path = "D:\\SEllinium\\Class work\\Day 11\\"+result.getName()+"png";
